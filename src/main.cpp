...
#if defined(NDEBUG)
# error "Cotecoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x841d75ab2ea7961b2acf3ad1b1f967f7bb5c309fa434f65e35f972a84008d33b");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Cotecoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Cotecoin Signed Message:\n";
...
{
    // Cotecoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
  ...
  if(nHeight == 2)  
    ...
    nSubsidy >>= (nHeight / 840000); // Cotecoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 10 * 30; // Cotecoin: 5 minutes
static const int64 nTargetSpacing = 1 * 30; // Cotecoin: 30 Seconds
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Cotecoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Cotecoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x841d75ab2ea7961b2acf3ad1b1f967f7bb5c309fa434f65e35f972a84008d33b");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "30th october 2017 cotecoin was built";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("040854017fa689ad5023690c80f3a49c8f13f8d45b8c629fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b842c45070ac7b03a9") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1509366124;
        ...
        assert(block.hashMerkleRoot == uint256("0x6480852d5f0d8749bfe5fb2b3bb8f75a3e16e489b7f5a638e447c7ece045a9dd"));
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Cotecoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("CotecoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("CotecoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static CotecoinMiner(CWallet *pwallet)
{
    printf("CotecoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("cotecoin-miner");
    ...
    try { loop {
        ...
        printf("Running CotecoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("CotecoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&CotecoinMiner, pwallet));
}
