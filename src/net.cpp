...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Cotecoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"cotecointools.com", "35.198.87.147"},
 {"cotecointools.com", "146.148.102.79"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Cotecoin is probably already running."), addrBind.ToString().c_str());
        else
